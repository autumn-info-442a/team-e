    ...
    componentDidMount () {
      ...
      clickSubmitHandler() {
        ...
        if(this.state.postTitle.length < 1) {
            ...
            this.createBlogPost(this.state.auth, this.props.groupId, this.state.postTitle, this.state.postContent)
        }
      }
            ...
            <DialogContent>
              ...
              <Container style={{ padding: "1.5rem 0" }} maxWidth="md">
                  <Grid container spacing={3}>
                      <TextField required label="Post Title" fullWidth onChange={this.handlePostTitleChange} />
                      <div style={{ margin: "10px 0px 3px 0px" }}>Post Content</div>
                      <TextareaAutosize style={{ width: "100%" }} label="Post Content" rowsMin={5} fullWidth onChange={this.handlePostContentChange} />
                      <Button id = "create" variant= "dark" size= "sm" onClick={() => this.clickSubmitHandler()}>Create Post</Button>
                      <hr></hr>
